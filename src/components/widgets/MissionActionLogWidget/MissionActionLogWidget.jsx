...
import MissionActionLogWidgetComponent from "./MissionActionLogWidgetComponent.jsx";
...
class MissionActionLogWidget {
  ...
  render(onEdit) {
    return React.createElement(MissionActionLogWidgetComponent, {
      widget: this,
      onEdit,
    });
  }
  ...
  renderDesignMode() {
    return React.createElement(
      ...
      [
        React.createElement(
          "div",
          { className: "widget-header", key: "header" },
          [
            React.createElement(
              "div",
              { className: "widget-info", key: "info" },
              [
                React.createElement(
                  "h3",
                  { className: "widget-title", key: "title" },
                  this.title
                ),
                React.createElement(
                  "p",
                  { className: "widget-settings", key: "settings" },
                  "No settings"
                ),
              ]
            ),
  ...
  renderDisplayMode() {
    ...
    return (
      ...
      >
        ...
        <div
          className={`log-container ${this.autoScroll ? "auto-scroll" : ""}`}
        >
            ...
            filteredLogs.map((entry) => (
              <div key={entry.id} className={`log-entry ${entry.level}`}>
                <span className="log-icon">
                  {this.getLogLevelIcon(entry.level)}
                </span>
                {this.showTimestamp && (
